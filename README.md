...
Отключил одну из нод, к которой подключался из скрипта producer.py.
Затем поправил параметры подключения в скрипте consumer.py на вторую ноду и запустил его.
